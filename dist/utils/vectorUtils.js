 ...
 */
export const formatVectorLiteral = (embedding) => {
 ...
 */
export const buildVectorUpdateQuery = (vectorLiteral, chunkId) => {
 ...
 */
export const buildVectorSearchQuery = (vectorLiteral, userId, topK) => {

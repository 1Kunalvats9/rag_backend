      ...
      `;
            try {
                ...
                for (const txt of batch) {
                    try {
                        await prisma.$executeRawUnsafe(`INSERT INTO "Chunk" ("id", "userId", "fileId", "text", "embedding", "createdAt")
               VALUES (gen_random_uuid(), $1, $2, $3, '[0.0]'::vector, NOW())`, user.userId, fileId, txt);
                    }

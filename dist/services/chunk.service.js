 ...
 */
export const getUserChunks = async (userId) => {
 ...
 */
export const getFileChunks = async (fileId, userId) => {
    return await prisma.chunk.findMany({
        where: {
            fileId,
 ...
 */
export const searchChunksByText = async (userId, searchText, limit = 10) => {
    return await prisma.chunk.findMany({
        where: {
            userId,
            text: {
 ...
 */
export const getChunkCount = async (userId) => {
 ...
 */
export const getFileChunkCount = async (fileId, userId) => {
    return await prisma.chunk.count({
        where: {
            fileId,
            userId,
 ...
 */
export const deleteFileChunks = async (fileId, userId) => {
